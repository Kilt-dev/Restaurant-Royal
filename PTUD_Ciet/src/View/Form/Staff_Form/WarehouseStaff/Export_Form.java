...
public class Export_Form extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        txtslPXK = new View.Swing.MyTextField();
        lbPXK = new javax.swing.JLabel();
        jSeparator2 = new javax.swing.JSeparator();
        jScrollPane1 = new javax.swing.JScrollPane();
        tablePXK = new View.Swing.Table();
        cmdAdd = new View.Swing.Button();
        cmdCT = new View.Swing.Button();
    ...
    private View.Swing.Button cmdCT;
    ...
    private View.Swing.Table tablePXK;
    private View.Swing.MyTextField txtSearch;
    private View.Swing.MyTextField txtslPXK;
