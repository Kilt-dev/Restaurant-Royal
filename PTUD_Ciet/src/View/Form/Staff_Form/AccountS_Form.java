...
import View.Main_Frame.Main_Staff_Frame;
...
private MS_ChangePassword changepass;
    ...
    private void initComponents() {
        ...
        txtngVL = new View.Swing.MyTextField();
        titleKH = new javax.swing.JLabel();
        lbtenNV = new javax.swing.JLabel();
        txttenNV = new View.Swing.MyTextField();
        lbngVL = new javax.swing.JLabel();
        lbCvu = new javax.swing.JLabel();
        txtCvu = new View.Swing.MyTextField();
        lbNQL = new javax.swing.JLabel();
        txtMaNQL = new View.Swing.MyTextField();
        ...
        txtSDT = new View.Swing.MyTextField();
        lbSDT = new javax.swing.JLabel();
        txtmaNV = new View.Swing.MyTextField();
    ...
    private View.Swing.MyTextField txtCvu;
    private View.Swing.MyTextField txtMaNQL;
    private View.Swing.MyTextField txtSDT;
    private View.Swing.MyTextField txtemail;
    private View.Swing.MyTextField txtmaNV;
    private View.Swing.MyPasswordField txtmatkhau;
    private View.Swing.MyTextField txtngVL;
    private View.Swing.MyTextField txtrole;
    private View.Swing.MyTextField txttenNV;
