package View.Form.Staff_Form.Staff;

import Controller.Service.ServiceCustomer;
import Controller.Service.ServiceStaff;
import Model.ModelBan;
import Model.ModelCTHD;
import Model.ModelHoaDon;
import Model.ModelNguoiDung;
import Model.ModelNhanVien;
import View.Dialog.MS_PaymentSuccess;
import View.Dialog.MS_Success;
import View.Form.MainForm;
import View.Main_Frame.Main_Admin_Frame;
...
public class BillS_Form extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        txtidHD = new View.Swing.MyTextField();
        lbidHD = new javax.swing.JLabel();
        jSeparator3 = new javax.swing.JSeparator();
        cmdExportBill = new View.Swing.Button();
        jScrollPane1 = new javax.swing.JScrollPane();
        tableCTHD = new View.Swing.Table();
        lbTienmonan = new javax.swing.JLabel();
        txtTienmonan = new View.Swing.MyTextField();
        lbTiengiam = new javax.swing.JLabel();
        txtTiengiam = new View.Swing.MyTextField();
        txtTiengiam.setVisible(false);
        lbTongtien = new javax.swing.JLabel();
        txtTongtien = new View.Swing.MyTextField();
        lbTienKH = new javax.swing.JLabel();
        txtTienKH = new View.Swing.MyTextField();
        lbTientra = new javax.swing.JLabel();
        txtTientra = new View.Swing.MyTextField();
        lbidKH = new javax.swing.JLabel();
        txtidKH = new View.Swing.MyTextField();
    ...
    private View.Swing.Button cmdExportBill;
    ...
    private View.Swing.Table tableCTHD;
    private View.Swing.MyTextField txtTienKH;
    private View.Swing.MyTextField txtTiengiam;
    private View.Swing.MyTextField txtTienmonan;
    private View.Swing.MyTextField txtTientra;
    private View.Swing.MyTextField txtTongtien;
    private View.Swing.MyTextField txtidHD;
    private View.Swing.MyTextField txtidKH;
