...
public class ImportStatistic_Form extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        txtprofit = new View.Swing.MyTextField();
        lbCus = new javax.swing.JLabel();
        jSeparator2 = new javax.swing.JSeparator();
        jScrollPane1 = new javax.swing.JScrollPane();
        tablePNK = new View.Swing.Table();
        lbDate = new javax.swing.JLabel();
        jLabel1 = new javax.swing.JLabel();
        filter = new javax.swing.JComboBox<>();
        cmdCTNK = new View.Swing.Button();
        cmdExcel = new View.Swing.Button();
    ...
    private View.Swing.Button cmdCTNK;
    private View.Swing.Button cmdExcel;
    ...
    private View.Swing.Table tablePNK;
    private View.Swing.MyTextField txtSearch;
    private View.Swing.MyTextField txtprofit;
